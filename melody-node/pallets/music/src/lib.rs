...
use melody_primitives::nft::NftInfo;
use melody_primitives::priority::Priority;
use melody_primitives::property::Property;
use melody_primitives::nft::{Nft, RoyaltyInfo, AccountIdOrCollectionNftTuple};
use melody_primitives::resource::{Resource, ResourceInfo, ResourceTypes};
use melody_primitives::collection::{Collection, CollectionInfo};
use melody_primitives::types::*;
...
pub mod pallet {
	...
	use melody_primitives::collection::CollectionInfo;
	use melody_primitives::nft::AccountIdOrCollectionNftTuple;
	use melody_primitives::resource::{BasicResource, ComposableResource, SlotResource};
